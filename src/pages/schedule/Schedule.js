...
function ClipperIcon({useColor}) {
   return (
       <svg className={useColor} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="14 1 36 62" style={{objectFit: "contain", height: "1.5em"}}>
...
function ToothbrushIcon({useColor}) {
   return (
       <svg className={useColor} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px"
...
function DailyToDo({tasks}) {
   const t = tasks.toLowerCase();

   return (
       <div style={{display: "flex", justifyContent: "space-evenly"}}>
          {t.includes("wash")? <SpongeIcon useColor={taskColor(t, "wash")} />:""}
          {t.includes("brush")? <ToothbrushIcon useColor={taskColor(t, "brush")} />:""}
          {t.includes("clip")? <ClipperIcon  useColor={taskColor(t, "clip")} />:""}
...
function Schedule() {
   ...
   return (
      <>
         ...
         <p><b>2-session</b> tooth-brushing streak. Keep those chompers cleaned!</p>
         {nailsClipped?
         ...
         <div className="grooming-calendar">
            ...
            <ul className="days">
               ...
               <li className="active">8<DailyToDo tasks={"wash" + (washed? "_done":" ") + "clip" + (nailsClipped? "_done":"")} /></li>
               <li>9<DailyToDo tasks="brush" /></li>
               <li>10<DailyToDo tasks="" /></li>
               <li>11<DailyToDo tasks="brush" /></li>
               <li>12<DailyToDo tasks="" /></li>
               <li>13<DailyToDo tasks="brush" /></li>
               <li>14<DailyToDo tasks="" /></li>
               <li>15<DailyToDo tasks="brush" /></li>
